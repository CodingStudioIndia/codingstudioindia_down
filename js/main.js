...
(function($) {
    ...
    var cfg = {
        ...
        mailChimpURL   : 'https://facebook.us8.list-manage.com/sbscribe/post?u=cdb7b577e41181934ed6a6a44&amp;id=e6957d85dc'   // mailchimp url
    },
...
janelaPopUp.fecha = function(id){
    if(id !== undefined){
        $("#" + id).removeClass("popUpEntrada").addClass("popUpSaida"); 
            ...
            $("#popFundo_" + id).fadeOut(2000, function(){
                $("#popFundo_" + id).remove();
        ...
        $(".popUp").removeClass("popUpEntrada").addClass("popUpSaida"); 
            ...
            $(".popUpFundo").fadeOut(2000, function(){
                $(".popUpFundo").remove();
                $(".popUp").remove();
                $("window, body").css('overflow', 'auto');
            });
